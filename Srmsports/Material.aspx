...
<div class="container">
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
            ...
            <asp:label for="Studentname" class="control-label " runat="server" ForeColor="#cc0000">Student Name</asp:label>
            ...
            <asp:label for="Materialname" class="control-label " runat="server" ForeColor="#cc0000">Material Name</asp:label>
         ...
         <div class="form-group" >
            ...
            <asp:label ID="Label1" for="MaterialType" class="control-label " runat="server" ForeColor="#cc0000">Type</asp:label>
            ...
            <asp:label for="Quantity" class="control-label " runat="server" ForeColor="#cc0000">Quantity</asp:label>
               ...
               <asp:Button ID="Button2" runat="server" Text="Reset" 
                    class="form-control btn btn-default" width="100px" OnClick="Button2_Click" />  
